          ...
          <div>
            <div class="w-full column gap-2 datosContainer py-2">
              <div class="column gap-1">
                <p>Nombre</p>
                <p class="datos text-blue">{{ profesional.nombre }}</p>
              </div>
              <div class="column gap-1">
                <p>Apellido</p>
                <p class="datos text-blue">{{ profesional.apellido }}</p>
              </div>
              <div class="column gap-1">
                <p>CUIL</p>
                <p class="datos text-blue">{{ profesional.cuil }}</p>
              </div>
              <div class="column gap-1">
                <p>Correo electrónico</p>
                <p class="datos text-blue">{{ profesional.email }}</p>
              </div>
            </div>
            <div
            ...
            >
              <div class="column gap-1">
                ...
                <p class="datos text-blue">
                  {{ formatearLista(profesional.especialidades) }}
                </p>
              </div>
              <div class="column gap-1">
                <p>Subespecialidad</p>
                <p class="datos text-blue">
                  {{ formatearLista(profesional.subespecialidades) }}
                </p>
              </div>
            </div>
            <div class="w-full column gap-2 datosContainer py-2">
              ...
              <div class="column gap-1">
                <p>Tipo de agenda</p>
                <p class="datos text-blue">{{ profesional.tipoAgenda }}</p>
              </div>
            </div>
          </div>
  ...
  methods: {
    ...
    validarCuil() {
      ...
      if (!cuil) {
        ...
        this.validationErrors.cuil = "El CUIL debe tener al menos 2 caracteres";
      } else {
    ...
    validarEmail() {
      ...
      if (!email) {
        this.validationErrors.email = "Debes ingresar un correo electrónico";
    ...
    validarTurnos() {
      ...
      if (turnos.length === 0) {
        this.validationErrors.turnos = "Debes seleccionar al menos un turno";
      } else {
    ...
    agregarProfesional() {
      // Router push AddProfesionalesConfirmation
