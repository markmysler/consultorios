      ...
      <StepperPanel>
        <template #content="{ nextCallback }">
          <div class="column gap-3">
            <p class="fechasIntro">
              Recuerde que puede solicitar una licencia a partir de 10 o 36 días
              dependiendo de sus tipos agenda.
            </p>
          ...
          <div>
            <div class="rowSpaceBetween py-2">
              <div class="column gap-3">
                <div class="datoLicencia column gap-1">
                  ...
                  <p>
                    {{ formatDate(licenciaSolicitada.fechaInicio) }}
                  </p>
                </div>
                <div class="datoLicencia column gap-1">
                  <p>Fin de licencia</p>
                  <p>
                    {{ formatDate(licenciaSolicitada.fechaFin) }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="rowSpaceBetween py-2">
              <div class="datoLicencia column gap-1">
                ...
                <img :src="licenciaSolicitada.imagen" class="imagenLicencia" />
              </div>
            </div>
          </div>
  ...
  methods: {
        ...
        (error) => {
          ...
          switch (error.code) {
            case "storage/unauthorized":
              console.error("User doesn't have permission to upload the file");
              break;
    ...
    validarImagen(nextCallback) {
      if (!this.licenciaSolicitada.imagen) {
        this.validationErrors.imagen = "Debe subir una imagen de su licencia.";
      } else {
