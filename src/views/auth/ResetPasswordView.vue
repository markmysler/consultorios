<template>
  <div class="columnAlignCenter pt-5 px-4">
    ...
    <div class="w-full column">
      ...
      <Button @click="sendEmail" :loading="loading" class="primaryButton" label="Restablecer contraseña"></Button>
    </div>
  </div>
</template>
          ...
          sendPasswordResetEmail(auth, email.value)
            ...
            .catch((error) => {
              console.log(error);
					...
					loading.value = false;
					error.value = "Ninguna cuenta coincide con este correo electrónico. Ingrese un correo electrónico diferente."
        }
      });
    } else {
			loading.value = false;
